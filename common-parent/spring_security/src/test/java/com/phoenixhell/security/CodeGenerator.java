...
//        gc.setOutputDir("E:\\online-teaching\\service\\service-edu\\src\\main\\java");
        gc.setOutputDir("E:\\spring-security\\common-parent\\spring_security\\src\\main\\java");
        gc.setAuthor("phoeixhell");
        gc.setOpen(false); //生成后是否打开资源管理器
        gc.setFileOverride(false); //重新生成时文件是否覆盖
        gc.setServiceName("%sService");	//去掉Service接口的首字母I ITOrderService
...
//        dsc.setPassword("159629zxc");
        ...
        pc.setModuleName("serviceOrder"); //模块名 包名最后一个
...
//        strategy.setTablePrefix(pc.getModuleName() + "_"); //生成实体时去掉表前缀 TOrder
        strategy.setTablePrefix("t_"); //生成实体时去掉表前缀 t_order 去掉t_
